...
abstract class CoupletTitleBar extends AbstractTitleBar implements View.OnClickListener {
    ...
    protected <T extends View> T setRightView(int viewLayoutRes) {
        ...
        rightView.findViewById(R.id.right_two).setOnClickListener(this);
        return (T) rightView;
    }
    ...
    public void onClick(View view) {
        ...
        } else if (view.getId() == rightView.findViewById(R.id.right_two).getId()) {
            onRightTwoViewClick(view);
    ...
    abstract void onRightTwoViewClick(View view);
}
